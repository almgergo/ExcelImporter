...
public class WorkedDay {
	...
	protected static Calendar sixMorning;
	protected static Calendar sixEvening;
	{
	...
	protected int differentStarts = 0;
	protected int fourHourDifferenceIsMet = 0;
	...
	public long getBonusMinutes() throws Exception {
		...
		// }
		// }
		// normalHourCount.get(Calendar.HOUR_OF_DAY)*60 +
		// normalHourCount.get(Calendar.MINUTE);
